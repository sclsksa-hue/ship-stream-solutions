...
import { UserPlus, Building2, Target, FileText, Phone, Mail, Calendar } from "lucide-react";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    async function load() {
      const [leads, customers, opportunities, quotations, activities] = await Promise.all([
    ...
    <AppLayout>
      ...
      <div className="grid gap-6 lg:grid-cols-2 mt-6">
        ...
        <Card className="animate-fade-in">
          <CardHeader>
            <CardTitle className="font-display">Pipeline Value by Salesperson</CardTitle>
          </CardHeader>
          <CardContent>
